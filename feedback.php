...
$sql="INSERT INTO `db1`.`feedback`(`username`, `rating`, `comment`) VALUES ('$username', '$rating', '$comment');";
// echo $sql;
...
<!--Homepage-->
    <section id="banner">
        ...
        <div class="banner-text">
            ...
            <p class="submitMsg">Thanks for submiting your feedback</p>
          <div class="banner-btn">
              <a href="pickup.html" class="banner-btn" id="button1"><span></span>Pickup Request</a>
              <a href="#" class="banner-btn" id="button"><span></span>Login</a>
          </div>
        </div>
<!--forms--> 
        <div class="popup">
    ...
    <div class="pop-up2">
        <div class="login-page2">
            <div class="form2">
                ...
                <!--feedback form-->
                <form class="Review Form" action="feedback.php" method="POST" >
                    <input type="text" name="username"placeholder="User Name" required=""/>
                    <input type="number" name="rating" placeholder="Rating(Out Of 5)" required=""/>
                    <input type="text" name="comment" placeholder="Any Other Comment"required=""/>
